...
class EventSaver {
    ...
    execute() {
        return __awaiter(this, void 0, void 0, function* () {
            const logging = new notifications_1.EventSaverLogging(this._context.log, this.getBatchName());
            try {
                yield logging.start();
    ...
    _saveEvents(events) {
        return __awaiter(this, void 0, void 0, function* () {
            const eventTable = new event_1.EventTableAccessor(this._db.connection, this.getModelObject());
    ...
    _getEvents() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            this._context.log.info('target contract address:' + contractInfo.get('contract_info_address'));
            yield event.generateContract(JSON.parse(contractInfo.get('contract_info_abi')), contractInfo.get('contract_info_address'));
            const events = yield event.getEvent(this.getEventName(), Number(maxBlockNumber) + 1, approvalBlockNumber);
            return events;
        });
    }
    _getContractInfo() {
        return __awaiter(this, void 0, void 0, function* () {
            const contractInfoAccessor = new contract_info_1.ContractInfoAccessor(this._db.connection);
            const info = yield contractInfoAccessor.getContractInfo(this.getContractName());
